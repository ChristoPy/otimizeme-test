...
<template>
  <div class="flex gap-4">
    <form id="form">
      <BaseInput id="cardNumber" label="Número do cartão" placeholder="Digite somente os números" type="tel" v-model="formData.number" />
      <BaseInput id="name" label="Titular do cartão" placeholder="Digite o nome impresso no cartão" type="name" v-model="formData.holder"/>
